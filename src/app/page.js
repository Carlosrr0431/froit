  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <a
        ...
        className={`fixed bottom-5 right-4 md:bottom-6 md:right-6 z-50 grid h-12 w-12 place-items-center rounded-full bg-emerald-500/95 text-white shadow-lg shadow-emerald-600/30 backdrop-blur transition-all duration-200 hover:scale-105 hover:shadow-emerald-600/50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-emerald-500 md:h-14 md:w-14 ${showWhatsApp ? 'opacity-100 translate-y-0' : 'pointer-events-none translate-y-3 opacity-0'}`}
      >
        <svg
